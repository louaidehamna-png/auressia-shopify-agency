...
export const articles: BlogArticle[] = [
  ...
  },
  {
    ...
    content: [
      ...
      "Un devis envoyé et resté sans réponse après 3 jours déclenche automatiquement un email de relance personnalisé. C'est l'automatisation qui a le plus d'impact direct sur le chiffre d'affaires, car la majorité des devis non relancés finissent simplement oubliés — pas refusés.",
  ...
  },
  {
    ...
    content: [
      ...
      "L'erreur la plus fréquente, c'est de vouloir transformer toute l'entreprise en même temps : automatiser le service client, le marketing, la comptabilité, le recrutement, tout en même temps. Résultat : le projet devient trop gros, prend des mois, coûte cher, et le dirigeant abandonne avant d'avoir vu le moindre résultat concret.",
